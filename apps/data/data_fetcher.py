...
def data_fetch_function(
    sql_functions_wrapper: SQLFunctionsWrapper,
    up_to_date_data_tester: UpToDateDataTester,
):
    ...
    params = {
        ...
        "where": {
            f"offshoreonshore = 'Offshore' and datetime = date'{selected_timeslot}'"
        },
    }
    ...
    try:
        ...
        if (data_power is None) and (data_monitoredcapacity is not None):
            ...
            test_result = (
                up_to_date_data_tester.test_for_already_present_monitored_capacity(
            ...
            if test_result:
                ...
                sql_functions_wrapper.insert_update_delete_query_wrapper(
                    query_text=insert_query, query_data=query_data
                )
            ...
            test_result = up_to_date_data_tester.test_for_already_present_full_record(
                selected_timeslot_datetime
            )
            ...
            if test_result:
                ...
                if selected_timeslot_datetime != last_datetime:
                    ...
                    sql_functions_wrapper.insert_update_delete_query_wrapper(
                        query_text=update_query, query_data=query_data
                    )
